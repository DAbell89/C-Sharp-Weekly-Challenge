...
namespace CodeLou.CSharp.Week2.Challenge
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var countMax = Console.ReadLine();
            int countConverted = 0;
            if (int.TryParse(countMax, out countConverted))
            {
                ...
                if (IsLessThanOrEqualToZero(countConverted))
                {
                ...
                else
                {
                    ...
                    while (countConverted >= 0)
                    {
                        Console.WriteLine(countConverted);
                        countConverted--;
                    }
